...
define('BASE_DIR', '/custom');
define('BASE_DIR_SWF', '/player_jqp.swf');
define('BASE_DIR_SWF2', '/player_jw.swf');

define('IMAGE_WIDTH', 200);
define('IMAGE_HEIGHT', 200);

define('IMAGE_MAIN_WIDTH', 340);
define('IMAGE_MAIN_HEIGHT', 340);

$arr = pathinfo(__FILE__);
$tmp = $arr['dirname'];
$tmp .= DS . "..";$tmp .= DS . ".." . DS;
#define('DIR_PREFIX', 'C:' . DS . 'xampp' . DS . 'htdocs' . DS . 'SMARTER-eVCS-webapp' . DS);
define('DIR_PREFIX', $tmp);
define('DIR_EXPORT', DIR_PREFIX . 'app' . DS . 'webroot' . DS . 'export' . DS);
define('DIR', DIR_PREFIX . 'app' . DS . 'webroot' . DS . 'custom' . DS);